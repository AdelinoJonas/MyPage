...
function Icons() {
    return (
      <div className="icons">
          <img className=" imageIcon html" src={html55} alt="icons language HTML5"/>
          <img className="imageIcon css" src={css3} alt="icons language CSS3"/>
          <img className="imageIcon js" src={javaScript} alt="icons language JAVASCRIPT"/>
          <img className="imageIcon node" src={nodejs} alt="icons language NODE.JS"/>
